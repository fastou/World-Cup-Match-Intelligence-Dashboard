...
- Competition labels and models must distinguish national-team and club fixtures: UEFA club fixtures are club competitions, July/August UEFA club games are qualifying rounds when metadata is thin, and club fixtures need a club baseline from competition tier, league/club strength snapshots, and visible source confidence instead of reusing the national-team default rating.

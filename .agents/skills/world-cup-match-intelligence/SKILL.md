...
- In knockout rounds, do not over-downgrade BTTS Yes from favorite clean-sheet priors alone. If current-tournament BTTS, underdog scoring, or team form supports both teams scoring, reduce the clean-sheet penalty and require stronger evidence before promoting BTTS No.
